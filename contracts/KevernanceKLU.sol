...
contract Governance is Ownable, IGovernance {
    ...
    uint256 public proposeTokenCount = 0;
    ...
    function setProposeTokenCount(uint256 _count) onlyOwner external {
        proposeTokenCount = _count;
    }
    ...
    function propose(
        ...
        require(_tokenIds.length == proposeTokenCount);
        ...
        for (uint256 index = 0; index < proposeTokenCount; index = index.add(1)) {
